            ...
            <div className="grid grid-cols-4 gap-4">
                {
                    helper.map((cocktail) => {
                        return cocktail.name === "helper name"
                            ...
                            :
                            (
                                <div onClick={() => {handleClickOnLastCocktails(cocktail)}} className="group p-4 my-card transition duration-300 hover:scale-105 hover:bg-neutral cursor-pointer tooltip tooltip-accent" data-tip="See this cocktail again">
